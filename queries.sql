-- Q4
select f.facility_id, f.facility_name, j1.nurse_type_needed, (sum(j1.total_number_nurses_needed) - sum(j1.hired_count)) as total from
	(
...
group by f.facility_id, f.facility_name, j1.nurse_type_needed
order by f.facility_id, j1.nurse_type_needed;

-- Q5
select n1.nurse_id, n1.nurse_type, n2.total_jobs, n1.joined_count, (n2.total_jobs-n1.joined_count) as available_jobs from
(
	select n.nurse_id, n.nurse_type, count(job_id) as joined_count from nurses n
...
select n1.nurse_id, n1.nurse_type, (count(j.job_id) - n1.joined_count) as available_jobs from
(
	select n.nurse_id, n.nurse_type, count(job_id) as joined_count from nurses n
	left join nurse_hired_jobs h on n.nurse_id = h.nurse_id
	group by n.nurse_id
) as n1 
left join jobs j on n1.nurse_type=j.nurse_type_needed
group by n1.nurse_id, n1.nurse_type, n1.joined_count
order by n1.nurse_id;
...
select distinct n.nurse_id, n.nurse_name, n.nurse_type from nurse_jobs_view n
